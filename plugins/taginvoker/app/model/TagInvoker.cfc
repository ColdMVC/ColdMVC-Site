<cfcomponent output="false" accessors="true" singleton="true" initMethod="setup">
...
<cfloop collection="#tags#" item="key">
	...
	<cffunction name="invoke" access="public" output="false" returntype="string">
		...
		<cfreturn new plugins.taginvoker.app.model.Tag(variables.template, arguments.tag, arguments.attributes) />
